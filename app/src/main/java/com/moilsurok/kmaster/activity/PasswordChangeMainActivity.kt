...
import com.moilsurok.kmaster.databinding.ActivityPasswordChangeMainBinding

class PasswordChangeMainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityPasswordChangeMainBinding
    private var oldPwd = ""
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPasswordChangeMainBinding.inflate(layoutInflater)
