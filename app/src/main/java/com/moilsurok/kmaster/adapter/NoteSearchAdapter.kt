...
//    @NoteAdapter("app:imageUrl")
    val iduser: String,
    val context: Context,
    val searchList: ArrayList<UserSearchDataClass>,
...
//        Log.d("test입니다", "testsete")
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        var viewHolder = (holder as NoteSearchAdapter.ViewHolder).itemView
        val user: UserSearchDataClass = searchList[position]
